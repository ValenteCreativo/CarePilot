...
exports.runBlurPerformanceValidation = runBlurPerformanceValidation;
exports.getRecommendedClass = getRecommendedClass;
...
function validateBlurPerformance(cssContent) {
    const violations = [];
...
function runBlurPerformanceValidation() {
